...
const GeneralStatusTrendReview: React.FC = () => {
  ...
  const FinancialData = (filterData).map(({ jalali_date, income, expense, profit, operating_cash_flow }) => {
  ...
  if (FinancialData.length === 0) return <div>داده‌ای برای نمایش وجود ندارد</div>;
  ...
  return (
    <>
    <h5 style={{textAlign:'center' , color:'#808080'}}> عملکرد مالی </h5>
