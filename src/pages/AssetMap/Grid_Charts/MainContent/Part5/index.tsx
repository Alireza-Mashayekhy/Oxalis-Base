...
const EnvironmentLawsAndIssuespart5: SFC = () => {
  ...
  return (
    <AccodionWrapper
      ...
      title='تولید'
      tabs={[
        { label: " نمودار های تولید  ", value: 0, id: uuidv4() },
      ...
      <br/>
         ...
         <Grid className="containerCharts" container sx={{width : "100%"}}>
          <Grid item sm={6}>
          <ScatterHrChart />
          </Grid>
          <Grid item sm={6}>
        ...
        <Grid className="containerCharts" container sx={{width : "100%"}}>
         ...
         <div  className="containerCharts" style={{display:'flex', flexDirection:'row' , justifyContent:'center' , alignItems:'center'}}>
          <MapChart />
        </div>
         </> 
        ]}
