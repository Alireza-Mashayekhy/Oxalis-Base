...
const GeneralStatusTrendReview: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (rawData.length > 0) {
      ...
      rawData.forEach(({ jalali_date, inventory_stock, product , city}) => {
  ...
  return (
    <>
        <h5 style={{textAlign:'center' , color:'#808080' , marginTop: '20px'}}>موجودی محصول</h5>
    <ResponsiveContainer height={350} width="100%">
      ...
      >
        ...
        <YAxis 
          ...
          dx={-50}
        >
          <Label value="موجودی" angle={-90} position="insideLeft" dx={-20}/>
        </YAxis>
