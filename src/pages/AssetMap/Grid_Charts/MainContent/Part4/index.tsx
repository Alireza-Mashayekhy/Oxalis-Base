...
const EnvironmentLawsAndIssuespart4: SFC = () => {
  ...
  return (
    <AccodionWrapper
      ...
      title="فروش"
      tabs={[
        { label: "  نمودار های  فروش ", value: 0, id: uuidv4() },
      ]}
      children={[
        <>
        <br />
        <div style={{ display: 'grid', gridTemplateColumns: 'auto 1fr 1fr', justifyContent: 'center', alignItems: 'center', gap: '30px' }}>
          <span style={{ fontSize: '12px', marginRight: '30px', color: '#808080', whiteSpace: 'nowrap' }}>فیلتر داینامیک :</span>
          <CityFilter />
          <ProductFilter />
        </div>
        ...
        <div className="containerCharts" style={{ display: 'flex', flexDirection:'row', justifyContent: 'center', alignItems: 'center', gap: '30px' }}>
