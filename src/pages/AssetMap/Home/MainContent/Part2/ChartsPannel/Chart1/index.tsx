...
const Chart1: SFC<Chart1Props> = ({
  ...
  const barChartData = filterBasedOnVentureNameAndConvertingStringValueToNumber(
    bankperfund,
    fundName
  );
      ...
      <S.Container>
        <S.SwitchBtn>
          ...
          >
            ...
            >
              {showBarChart && <PieChartIcon sx={{ color: colors.white }} />}
              {!showBarChart && <BarChartIcon sx={{ color: colors.white }} />}
            </IconButton>
          </UTooltip>
        </S.SwitchBtn>
        {!showBarChart && (
